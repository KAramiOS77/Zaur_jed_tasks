...
let eded = Number(
  prompt("Kvadrat kökünü tapmaq istədiyiniz ədədi daxil edin:")
);
...
if (unit === "C") {
  ...
  alert("Zəhmət olmazsa, ölçü vahidini düzgün qeyd edin!");
}
...
let eded1 = Number(
  prompt(
    "işarəsini və ya 0 olub-olmadığnı təyin etmək istədiyiniz ədədi daxil edin :"
  )
);
...
let eded2 = Number(
  prompt("Tək və ya cüt olduğunu yoxlamaq istədiyiniz ədədi daxil edin:")
);
...
let muqaise1 = Number(
  prompt("Müqaisə etmək istədyiniz ədədlərdən ilkini daxil edin:")
);
let muqaise2 = Number(
  prompt("Müqaisə etmək istədyiniz ədədlərdən ikincisini daxil edin:")
);
let muqaise3 = Number(
  prompt("Müqaisə etmək istədyiniz ədədlərdən üçüncüsünü daxil edin:")
);
...
// Math.max ile
let mathMuqaise1 = Number(
  prompt("Müqaisə etmək istədyiniz ədədlərdən ilkini daxil edin:")
);
let mathMuqaise2 = Number(
  prompt("Müqaisə etmək istədyiniz ədədlərdən ikincisini daxil edin:")
);
let mathMuqaise3 = Number(
  prompt("Müqaisə etmək istədyiniz ədədlərdən üçüncüsünü daxil edin:")
);
...
switch (oprtr) {
  ...
  case "-":
    ...
    break;
  default:
    console.log("Bu operator desteklenmir");
}
