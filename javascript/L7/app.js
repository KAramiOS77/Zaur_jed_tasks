...
function ilkHerfiDeyis(str, s) {
  let ilkherf = str[0]; // A: str[0]-a menimsetmeye ne ehtiyac var? evezine s-den istifade ede bilersen.
  ilkherf = s;
  return ilkherf + str.slice(1, str.lenght); //A: length yazmamisan))) sehv yazmisansa nece isleyir?))
